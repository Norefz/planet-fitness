@php
    // Kumpulan ikon garis (stroke) sederhana, konsisten dengan gaya ikon
    // yang sudah dipakai di halaman login/register (feather-style, stroke-width 2).
    $icons = [
        ...
        'upload-cloud' => '<path d="M16 16l-4-4-4 4"/><path d="M12 12v9"/><path d="M20.4 17.4A4.5 4.5 0 0 0 18 9h-1.3A7 7 0 1 0 4 15.3"/>',
        ...
        'link'         => '<path d="M10 13a5 5 0 0 0 7.5.5l2-2a5 5 0 0 0-7-7l-1.2 1.2"/><path d="M14 11a5 5 0 0 0-7.5-.5l-2 2a5 5 0 0 0 7 7l1.1-1.1"/>',
        'inbox'        => '<polyline points="22 12 16 12 14 15 10 15 8 12 2 12"/><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11Z"/>',
    ];
@endphp
<svg class="{{ $class ?? 'w-4 h-4' }}" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
