  ...
  <div class="bg-white border border-slate-200 rounded-xl shadow-[0_1px_3px_rgb(0_0_0/.08)] overflow-hidden">
    ...
    <table class="w-full border-collapse">
      ...
      <tbody>
        ...
        @empty
          <tr>
            <td colspan="5" class="px-4 py-10 text-center text-[13px] text-slate-400">Tidak ada booking yang cocok dengan pencarian/filter ini.</td>
          </tr>
        @endforelse
      </tbody>
    </table>
    ...
    <div class="bg-white border border-slate-200 rounded-xl shadow-[0_1px_3px_rgb(0_0_0/.08)] overflow-hidden">
      ...
      <div class="grid grid-cols-7 gap-1 p-3 text-center">
        ...
        @for($day = 1; $day <= $daysInMonth; $day++)
          ...
          @endphp
          <div class="aspect-square flex items-center justify-center text-[11px] rounded-lg relative
                      {{ $isToday ? 'bg-primary text-white font-bold' : 'text-slate-700' }}">
            {{ $day }}
            @if($hasBooking && !$isToday)
      ...
      <div class="flex items-center gap-3 px-4 pb-3 text-[11px] text-slate-400">
        <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-amber-500"></span> Ada booking</span>
        <span class="flex items-center gap-1"><span class="w-2 h-2 rounded-full bg-primary"></span> Hari ini</span>
      </div>
    </div>
