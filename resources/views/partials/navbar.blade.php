...
>
    ...
    <div class="hidden md:flex items-center gap-8">
        ...
        <a href="{{ Auth::check() ? route('member.log-nutrisi') : route('nutrition.preview') }}"
           class="text-sm font-medium text-white/70 hover:text-[#4ade9e] transition-colors duration-200">
             Log Nutrisi
        </a>
    ...
    >
        ...
        <a href="{{ Auth::check() ? route('member.log-nutrisi') : route('nutrition.preview') }}" class="px-2 py-3 text-sm font-medium text-white/80 hover:text-[#4ade9e] rounded-lg no-underline">Log Nutrisi</a>
